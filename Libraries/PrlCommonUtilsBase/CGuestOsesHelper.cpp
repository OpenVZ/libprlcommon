...
#define ADD_OS_VER( ver ) _result.GetContainer().append( ver );
		...
		switch ( nOsType )
		{
			...
			case PVS_GUEST_TYPE_WINDOWS:
				...
				ADD_OS_VER( PVS_GUEST_VER_WIN_WINDOWS11 )
				ADD_OS_VER( PVS_GUEST_VER_WIN_2016 )
				ADD_OS_VER( PVS_GUEST_VER_WIN_2019 )
				ADD_OS_VER( PVS_GUEST_VER_WIN_2022 )
			...
			case PVS_GUEST_TYPE_LINUX:
				...
				ADD_OS_VER( PVS_GUEST_VER_LIN_REDHAT_8 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_REDHAT_9 )
				...
				ADD_OS_VER( PVS_GUEST_VER_LIN_CENTOS_8 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_VZLINUX )
				ADD_OS_VER( PVS_GUEST_VER_LIN_VZLINUX_7 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_VZLINUX_8 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_CLOUDLINUX )
				ADD_OS_VER( PVS_GUEST_VER_LIN_CLOUDLINUX_7 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_CLOUDLINUX_8 )
				ADD_OS_VER( PVS_GUEST_VER_LIN_ALMA_LINUX_9 )
